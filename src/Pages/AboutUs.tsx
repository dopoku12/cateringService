...
const AboutUs = () => {
   return <Box>
      <Typography>
      attended culinary arts after high school and graduated with a degree in Food Service Management and Culinary Nutrition. For the next three years, I leveraged my training and skills working for an assortment of high-end restaurants, of which included:Le Bouquet Restaurant (Aburi, Ghana) and La Palm Royal Beach Hotel (Labadi, Ghana).To broaden my prospects and opportunities,I relocated to the USA where I furthered my training at Montgomery College and Auguste Escoffier School of Culinary Arts (with a Specialty in Baking & Pastry Art). With my unique background, experience and education,I was able to secure a prestigious position with Brock & Company as a Catering Associate, which I hold to-date. 
